    ...
    public function run(): void
    {
        ...
        foreach ($languages as $lang) {
            Language::updateOrCreate(
                ['code' => $lang['code']],   // match on code
                [
                    'name'       => $lang['name'],
                    'rtl'        => $lang['rtl'],
                    'is_default' => $lang['code'] === 'en', // English is default
                    'is_active'  => false,   // not active until admin enables it
                ]
            );
        }

        // Make sure at least English is active
        Language::where('code', 'en')->update(['is_active' => true]);
    }
}